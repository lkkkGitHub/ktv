...
qikoo.dialog = function() {
    ...
    var r = qikoo.dialog.show({
        html: ['<div class="dialog-content">', '<div class="content-title">','<form action="" id="form1">标题：<input type="text" name="musicListName" style="height:28px;width:200px;"></from>','</div>', "</div>", '<div class="dialog-console clearfix_new" style="margin:25px auto;width:252px;">', '<a class="console-btn-confirm" href="#" onclick="return false;">新建歌单</a>', '<a class="console-btn-cancel" href="#" onclick="return false;">取消</a>', "</div>"].join(""),
        width: 350,
        closeFn: n
    });
